...
function ROICalculator() {
  ...
  const [traffic, setTraffic] = React.useState(1000);

  const estimatedLeads = Math.round((traffic * budget) / 100);
  ...
  return (
    ...
    >
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="text-3xl font-bold">
                {estimatedRevenue.toLocaleString()} AED
              </div>
            </div>
            <div className="pt-4 border-t border-white/20">
              <div className="text-gray-300 text-sm">Projected ROI</div>
              <div className="text-3xl font-bold text-green-300">
                {Math.round((estimatedRevenue / budget) * 100)}%
              </div>
            </div>
          </div>
        </div>
      ...
      <p className="mt-6 text-center text-sm text-gray-500">
        *Estimates based on industry averages and past campaign performance
      </p>
    </motion.div>
  );
}
