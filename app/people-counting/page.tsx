...
export default function PeopleCountingPage() {
  ...
  const heroImages = [
    { src: "/images/ppl-coun/pic-1.png", alt: "ZAISENSE people counting camera view 1" },
    { src: "/images/ppl-coun/pic-2.png", alt: "ZAISENSE people counting camera view 2" },
    { src: "/images/ppl-coun/pic-3.png", alt: "ZAISENSE people counting camera view 3" },
  ];
  ...
  return (
    <>
      <Head>
        <title>ZAISENSE AI-Powered People Counting | Technotronix</title>
        <meta
          name="description"
          content="Technotronix ZAISENSE offers advanced AI-powered people counting to transform footfall data into actionable insights. Real-time visitor tracking, predictive analytics, and privacy-first design."
        />
        ...
        <section className="relative h-[90vh] flex items-center justify-center text-center overflow-hidden bg-black">
          <div className="absolute inset-0 w-full h-full">
            <AnimatePresence mode="wait">
              ...
              >
                {/* Use a hidden Image for better alt semantics? */}
                <Image
                  src={heroImages[currentImage].src}
                  alt={heroImages[currentImage].alt}
                  width={1920}
                  height={1080}
                  className="invisible" // hidden visually, but alt is available for accessibility / SEO
                />
              </motion.div>
            </AnimatePresence>
          </div>
        ...
        <section className="max-w-6xl mx-auto px-6 sm:px-10 py-20 text-center">
          ...
          >
            ...
            <p className="text-lg leading-relaxed text-gray-600">
              ...
              transforms raw footfall data into powerful insights that help businesses make
              smarter, data-backed decisions. Designed for precision, scalability, and privacy,
              our platform empowers organizations to understand how people move, interact, and
