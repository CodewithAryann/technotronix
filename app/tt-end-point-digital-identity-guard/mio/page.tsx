...
import { Key, Lock, Users, Shield, GitPullRequest } from "lucide-react";
...
export default function MiniOrangeIAMPage() {
  ...
  return (
    <>
      {/* HEAD for canonical */}
      <Head>
        <title>miniOrange IAM – Identity & Access Management</title>
        <meta
          name="description"
          content="miniOrange IAM provides secure access, Zero Trust policies, and seamless user experience across all applications and devices."
        />
        <link
          rel="canonical"
          href="https://technotronix.ae/tt-end-point-digital-identity-guard/mio"
        />
      </Head>
