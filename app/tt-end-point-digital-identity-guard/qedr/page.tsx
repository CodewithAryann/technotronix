...
import { Activity, BrainCircuit, ShieldAlert, Search, Network } from "lucide-react";
...
export default function QASEDRPage() {
  ...
  return (
    <>
      {/* HEAD for SEO */}
      <Head>
        <title>QAS EDR – Endpoint Detection & Response</title>
        <meta
          name="description"
          content="QAS EDR provides real-time endpoint threat detection, AI-driven behavioral analytics, automated response, and seamless integration with SIEM and XDR platforms."
        />
        <link
          rel="canonical"
          href="https://technotronix.ae/tt-end-point-digital-identity-guard/qedr"
        />
      </Head>
