...
<div>
  ...
  <ul className="space-y-2 text-sm">
    <li>
      <Link href="/tt-cloud-guard" className="hover:text-white transition-colors">Cloud Guard</Link>
    </li>
    <li>
      <Link href="/tt-data-guard" className="hover:text-white transition-colors">Data Guard</Link>
    </li>
    <li>
      <Link href="/tt-perimeter-guard/ntem" className="hover:text-white transition-colors">Perimeter Guard</Link>
    </li>
    <li>
      <Link href="tt-operational-guard/sba" className="hover:text-white transition-colors">Operational Guard</Link>
    </li>
    <li>
      <Link href="tt-vulnerability-guard/nvm" className="hover:text-white transition-colors">Vulnerability Guard</Link>
    </li>
    <li>
      <Link href="/tt-end-point-digital-identity-guard/nes" className="hover:text-white transition-colors">Endpoint & Digital Guard</Link>
    </li>
  </ul>
</div>
  ...
  <ul className="space-y-4 text-sm">
    <li className="flex items-start gap-3">
      ...
      <span className="leading-relaxed">+971 4 4318 874</span>
    </li>
    <li className="flex items-start gap-3">
      <Mail size={18} className="text-white mt-0.5 shrink-0" />
      <span className="leading-relaxed">info@technotronix.ae</span>
    </li>
    <li className="flex items-start gap-3">
      <MapPin size={18} className="text-white mt-0.5 shrink-0" />
      <span className="leading-relaxed">
        Office 1208B, Business Central Towers – Tower B, Dubai Internet City,
        UAE
      </span>
    </li>
  </ul>
      ...
      <div className="border-t border-white/10 mt-12 pt-6 text-center text-sm text-gray-400">
        ...
        <span className="font-semibold text-white">Technotronix</span> — All
        rights reserved.
      </div>
    </footer>
  );
